-- Patches sp_list_all_pdfs to return the same full field set as
-- sp_list_pdfs_by_user.  Without this, Approver / Nodal / Admin document
-- viewers receive no values for effective_from, gazette_reference,
...
--   mysql -u <user> -p legal_pdf < scripts/patch_sp_list_all_pdfs_full_fields.sql
...
SELECT 'sp_list_all_pdfs patched with full field set.' AS status;
