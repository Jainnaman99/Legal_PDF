-- ============================================================
-- Adds total_count (window function) to sp_list_pdfs_by_user
-- so the API can return total alongside the paged results.
--
-- Run via sqlcmd:
--   sqlcmd -S 10.0.160.80 -U sa -P sa@123 -i scripts\update_sp_list_pdfs_by_user_count.sql
-- ============================================================
